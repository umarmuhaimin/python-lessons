...
# else statement : if the system meets the true value, it will end the code. If the system does not meet the true value, then it will assume the return value is false.
