🔁 Return Values – Structured Notes
...
• We can have two variable with the same name but different use because they’re in different scopes.  
...
Example of Side Effects (no return):
```python
